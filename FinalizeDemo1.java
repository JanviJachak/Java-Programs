...
class FinalizeDemo1
{
    public static void main(String arg[])
    {
        ...
        eobj.Display();
        eobj = null;  //sometimes finalize method cant get called... by writing null, chances of getting finalized method call is high
        
        System.gc();  //gc-garbage collector..... it will call finalize method
    }
}